...
namespace GymAPI.Migrations
{
    ...
    [Migration("20230808200604_CreateTrainingExercisesAssociativeTableBetweenTrainingAndExerciseTables")]
    partial class CreateTrainingExercisesAssociativeTableBetweenTrainingAndExerciseTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GymAPI.Models.TrainingExercises", b =>
                {
                    ...
                    b.HasIndex("TrainingOrganizationId");

                    b.ToTable("TrainingExercises");
                });

            modelBuilder.Entity("GymAPI.Models.TrainingOrganization", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TrainingsOrganizations");
                });
            ...
            modelBuilder.Entity("GymAPI.Models.TrainingExercises", b =>
                {
                    b.HasOne("GymAPI.Models.Exercise", null)
                        .WithMany()
                        .HasForeignKey("ExerciseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GymAPI.Models.Training", null)
                        .WithMany()
                        .HasForeignKey("TrainingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GymAPI.Models.TrainingOrganization", "TrainingOrganization")
                        .WithMany()
                        .HasForeignKey("TrainingOrganizationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TrainingOrganization");
                });
